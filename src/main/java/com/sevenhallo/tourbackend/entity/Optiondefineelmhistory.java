...
@Setter
@Entity
@Table(name = "optiondefineelmhistory", schema = "dbo")
public class Optiondefineelmhistory {
    @Id
    ...
    @Column(name = "text_ja", length = Integer.MAX_VALUE)
    private String textJa;

    @Column(name = "text_en", length = Integer.MAX_VALUE)
