...
@Setter
@Entity
@Table(name = "agentrelationhistory", schema = "dbo")
public class Agentrelationhistory {
    @Id
    ...
    @NotNull
    @Column(name = "agentrelationtype", nullable = false)
    private Integer agentrelationtype;
